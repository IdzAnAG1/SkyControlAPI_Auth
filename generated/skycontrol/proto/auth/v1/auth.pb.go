...
func (x *RegisterResponse) GetErrMessage() string {
	if x != nil {
		return x.ErrMessage
	}
	return ""
...
func (x *LoginResponse) GetErrMessage() string {
	if x != nil {
		return x.ErrMessage
	}
	return ""
...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x05Login\x12 .skycontrol.auth.v1.LoginRequest\x1a!.skycontrol.auth.v1.LoginResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/api/v1/auth/loginB\xce\x01\n" +
	"\x16com.skycontrol.auth.v1B\tAuthProtoP\x01Z?sc_auth/generated/skycontrol/proto/auth/v1/proto/auth/v1;authv1\xa2\x02\x03SAX\xaa\x02\x12Skycontrol.Auth.V1\xca\x02\x12Skycontrol\\Auth\\V1\xe2\x02\x1eSkycontrol\\Auth\\V1\\GPBMetadata\xea\x02\x14Skycontrol::Auth::V1b\x06proto3"
...
var file_proto_auth_v1_auth_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: skycontrol.auth.v1.RegisterRequest
	(*RegisterResponse)(nil), // 1: skycontrol.auth.v1.RegisterResponse
	(*LoginRequest)(nil),     // 2: skycontrol.auth.v1.LoginRequest
	(*LoginResponse)(nil),    // 3: skycontrol.auth.v1.LoginResponse
}
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	0, // 0: skycontrol.auth.v1.Auth.Register:input_type -> skycontrol.auth.v1.RegisterRequest
	2, // 1: skycontrol.auth.v1.Auth.Login:input_type -> skycontrol.auth.v1.LoginRequest
	1, // 2: skycontrol.auth.v1.Auth.Register:output_type -> skycontrol.auth.v1.RegisterResponse
	3, // 3: skycontrol.auth.v1.Auth.Login:output_type -> skycontrol.auth.v1.LoginResponse
